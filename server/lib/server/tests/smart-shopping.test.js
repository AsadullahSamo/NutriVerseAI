...
describe('Smart Shopping AI Features', () => {
    ...
    it('should create and retrieve shopping preferences', async () => {
        ...
        expect(result === null || result === void 0 ? void 0 : result.budgetLimits).toEqual(preferences.budgetLimits);
    });
    it('should track price history with AI predictions', async () => {
        ...
        expect(result).toBeDefined();
        expect(result === null || result === void 0 ? void 0 : result.aiPredictedPrice).toBe(3.15);
    });
    it('should create store-specific shopping list with AI optimizations', async () => {
        ...
        expect(result).toBeDefined();
        expect(result === null || result === void 0 ? void 0 : result.sustainabilityScore).toBe(85);
        expect(result === null || result === void 0 ? void 0 : result.optimizedRoute).toEqual(shoppingList.optimizedRoute);
    });
    it('should generate and store shopping insights', async () => {
        ...
        expect(result).toBeDefined();
        expect(result === null || result === void 0 ? void 0 : result.insights).toEqual(insights.insights);
        expect(result === null || result === void 0 ? void 0 : result.budgetAnalysis).toEqual(insights.budgetAnalysis);
    });
});
//# sourceMappingURL=smart-shopping.test.js.map