...
export async function getNutritionRecommendations(currentGoals, progress, preferences) {
...
export async function generateRecipe(ingredients, preferences = [], dietaryRestrictions = []) {
    try {
...
//# sourceMappingURL=recipe-ai.js.map