...
async function retryWithExponentialBackoff(operation, retryCount = 0) {
    ...
    try {
        ...
        if ((error === null || error === void 0 ? void 0 : error.status) === 429 || ((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('Resource has been exhausted'))) {
