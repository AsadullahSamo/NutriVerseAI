...
export async function generateAIMealPlan(preferences, days = 7, dietaryRestrictions, calorieTarget) {
    var _a, _b;
    // Enforce 7-day limit
    if (days > 7) {
    ...
    try {
        ...
        try {
            ...
            mealPlan.forEach((day, index) => {
                var _a, _b, _c, _d;
                if (!((_a = day.meals) === null || _a === void 0 ? void 0 : _a.breakfast) || !((_b = day.meals) === null || _b === void 0 ? void 0 : _b.lunch) || !((_c = day.meals) === null || _c === void 0 ? void 0 : _c.dinner) || !Array.isArray((_d = day.meals) === null || _d === void 0 ? void 0 : _d.snacks)) {
