            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-3 py-2 border border-input bg-background rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent capitalize hover:bg-accent hover:text-accent-foreground transition-colors cursor-pointer"
                >
                  ...
                  <option value="snack" className="hover:bg-accent hover:text-accent-foreground">Snack</option>
                </select>
              </div>
            </div>
            <div className="space-y-2">
