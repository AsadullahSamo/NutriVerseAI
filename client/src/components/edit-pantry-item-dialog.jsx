...
import { Pencil, Loader2, Info, Leaf, Recycle, AlertTriangle } from "lucide-react";
...
export function EditPantryItemDialog({ item, trigger }) {
    ...
    const form = useForm({
        ...
        defaultValues: {
            ...
            sustainabilityInfo: item.sustainabilityInfo || { score: 0, packaging: "recyclable", carbonFootprint: "low" }
        },
    });
    // Watch nutrition info fields for calculating sustainability score
    const nutritionInfo = form.watch("nutritionInfo");
    const calories = (nutritionInfo === null || nutritionInfo === void 0 ? void 0 : nutritionInfo.calories) || 0;
    const protein = (nutritionInfo === null || nutritionInfo === void 0 ? void 0 : nutritionInfo.protein) || 0;
    const carbs = (nutritionInfo === null || nutritionInfo === void 0 ? void 0 : nutritionInfo.carbs) || 0;
    const fat = (nutritionInfo === null || nutritionInfo === void 0 ? void 0 : nutritionInfo.fat) || 0;
    // Watch sustainability info fields
    const sustainabilityInfo = form.watch("sustainabilityInfo");
    const packaging = (sustainabilityInfo === null || sustainabilityInfo === void 0 ? void 0 : sustainabilityInfo.packaging) || "recyclable";
    const carbonFootprint = (sustainabilityInfo === null || sustainabilityInfo === void 0 ? void 0 : sustainabilityInfo.carbonFootprint) || "low";
    ...
    const currentSustainabilityScore = useMemo(() => {
        ...
        if (packaging === "biodegradable")
            modifiers += 10;
        else if (packaging === "recyclable")
            modifiers += 5;
        if (carbonFootprint === "low")
            modifiers += 10;
        else if (carbonFootprint === "medium")
            modifiers += 5;
        else if (carbonFootprint === "high")
            modifiers -= 5;
        ...
        form.setValue("sustainabilityInfo", Object.assign(Object.assign({}, currentSustainabilityInfo), { score: finalScore }), { shouldValidate: true });
        return finalScore;
    ...
    const editPantryItemMutation = useMutation({
        mutationFn: async (data) => {
            ...
            const currentSustainabilityInfo = form.getValues("sustainabilityInfo") || {};
            data.sustainabilityInfo = Object.assign(Object.assign({}, currentSustainabilityInfo), { score: currentSustainabilityScore });
            const formattedData = Object.assign(Object.assign({}, data), { expiryDate: data.expiryDate ? new Date(data.expiryDate).toISOString() : null });
        ...
        <div className="px-1 pb-6">
          <Form {...form}>
            <form onSubmit={form.handleSubmit((data) => editPantryItemMutation.mutate(data))} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <FormField control={form.control} name="expiryDate" render={({ field }) => (<FormItem>
                        <FormLabel>Expiry Date</FormLabel>
                        <FormControl>
                          <Input type="date" min={new Date().toISOString().split('T')[0]} value={field.value ? new Date(field.value).toISOString().split('T')[0] : ''} onChange={(e) => field.onChange(e.target.value ? new Date(e.target.value) : null)}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField control={form.control} name="nutritionInfo" render={(_a) => {
            var _b;
            var _c = _a.field, { value, onChange } = _c, field = __rest(_c, ["value", "onChange"]);
            return (<FormItem>
                        <FormLabel>Calories</FormLabel>
                        <FormControl>
                          <Input type="number" {...field} value={(_b = value === null || value === void 0 ? void 0 : value.calories) !== null && _b !== void 0 ? _b : '0'} onChange={e => {
                    const newValue = e.target.value ? parseInt(e.target.value) : 0;
                    onChange(Object.assign(Object.assign({}, value), { calories: newValue }));
                }}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>);
            ...
            return (<FormItem>
                        ...
                        <FormControl>
                          <Input type="number" {...field} value={(_b = value === null || value === void 0 ? void 0 : value.protein) !== null && _b !== void 0 ? _b : '0'} onChange={e => {
                    const newValue = e.target.value ? parseInt(e.target.value) : 0;
                    onChange(Object.assign(Object.assign({}, value), { protein: newValue }));
                }}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>);
            ...
            return (<FormItem>
                        ...
                        <FormControl>
                          <Input type="number" {...field} value={(_b = value === null || value === void 0 ? void 0 : value.carbs) !== null && _b !== void 0 ? _b : '0'} onChange={e => {
                    const newValue = e.target.value ? parseInt(e.target.value) : 0;
                    onChange(Object.assign(Object.assign({}, value), { carbs: newValue }));
                }}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>);
            ...
            return (<FormItem>
                        ...
                        <FormControl>
                          <Input type="number" {...field} value={(_b = value === null || value === void 0 ? void 0 : value.fat) !== null && _b !== void 0 ? _b : '0'} onChange={e => {
                    const newValue = e.target.value ? parseInt(e.target.value) : 0;
                    onChange(Object.assign(Object.assign({}, value), { fat: newValue }));
                }}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>);
            ...
            currentSustainabilityScore >= 40 ? 'bg-yellow-500/10 text-yellow-600' :
                'bg-red-500/10 text-red-600'}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="sustainabilityInfo.packaging" render={({ field }) => (<FormItem>
                    ...
                    <FormField control={form.control} name="sustainabilityInfo.carbonFootprint" render={({ field }) => (<FormItem>
                  ...
                  <div className="mt-4 p-4 bg-card rounded-lg border">
                    <h4 className="text-sm font-medium mb-3">Environmental Impact</h4>
                    <div className="flex items-center space-x-3 mb-2">
                      {getCarbonFootprintIcon(carbonFootprint)}
                      <Badge className={`${getCarbonFootprintColor(carbonFootprint)}`}>
                        {carbonFootprint.charAt(0).toUpperCase() + carbonFootprint.slice(1)} Carbon Footprint
                      </Badge>
                    </div>
                    <div className="text-xs text-muted-foreground mt-2">
                      {carbonFootprint === 'low' && 'This product has minimal environmental impact and aligns with sustainable consumption.'}
                      {carbonFootprint === 'medium' && 'This product has moderate environmental impact. Consider local and seasonal alternatives when possible.'}
                      {carbonFootprint === 'high' && 'This product has significant environmental impact. Consider using it sparingly or finding sustainable alternatives.'}
                    </div>
                    <div className="h-2 w-full bg-muted rounded-full mt-2 overflow-hidden">
                      <div className={`h-full rounded-full ${carbonFootprint === 'low' ? 'bg-green-500 w-1/3' :
            carbonFootprint === 'medium' ? 'bg-yellow-500 w-2/3' :
                'bg-red-500 w-full'}`}></div>
                    </div>
                  </div>
                </div>
              </div>
