      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div 
            ...
            className="absolute left-1/2 transform -translate-x-1/2 top-0 z-10 bg-background/90 backdrop-blur-sm border shadow-md rounded-md px-3 py-1.5 text-center"
          >
