...
interface RecommendationsViewProps {
  recommendations: EquipmentRecommendation[] | null;
  onRecommendationAction: (recommendation: EquipmentRecommendation) => void;
}
              ...
              >
                ...
                {recommendation.alternativeOptions && recommendation.alternativeOptions.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <ul className="text-sm space-y-1">
                      {recommendation.alternativeOptions.map((option: string, i: number) => (
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <Button
                    ...
                    onClick={() => window.open(`https://www.amazon.com/s?k=${encodeURIComponent(recommendation.name)}`, '_blank')}
                  >
                    Shop Online
