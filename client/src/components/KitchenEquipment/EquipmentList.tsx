...
import type { KitchenEquipment } from '@/ai-services/kitchen-inventory-ai';
...
export function EquipmentList({ equipment, onEquipmentUpdated }: EquipmentListProps) {
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  {item.lastMaintenanceDate && (
                    <p>Last maintained: {new Date(item.lastMaintenanceDate).toLocaleDateString()}</p>
                  )}
