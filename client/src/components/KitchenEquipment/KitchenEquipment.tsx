...
export function KitchenEquipment() {
  const [equipment, setEquipment] = useState<KitchenEquipmentFromDB[]>([]);
              ...
              {recipeMatches && (
                <div className="space-y-6">
                  <div>
                    ...
                    <ScrollArea className="h-[200px]">
                      <ul className="space-y-2">
                        {recipeMatches.possibleRecipes.map((recipe: any) => (
                          <li key={recipe.id} className="flex items-center justify-between">
                            <span>{recipe.title}</span>
                            <div className="flex gap-2">
                              {recipe.requiredEquipment.map((eq: string) => (
                  ...
                  <div>
                    ...
                    <ScrollArea className="h-[200px]">
                      <ul className="space-y-2">
                        {recipeMatches.recommendedPurchases.map((rec: any, i: number) => (
