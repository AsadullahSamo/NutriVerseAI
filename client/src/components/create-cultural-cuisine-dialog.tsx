...
import { z } from "zod";
import { CulturalCuisineDetails } from "@/types";
...
interface CreateCulturalCuisineDialogProps {
  trigger?: React.ReactNode;
}

export function CreateCulturalCuisineDialog({ trigger }: CreateCulturalCuisineDialogProps) {
