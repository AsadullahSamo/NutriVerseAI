...
export function CreateMealPlanDialog({ open, onOpenChange }) {
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={(e) => {
          ...
          <div className="space-y-2">
            ...
            <Input id="title" placeholder="My Meal Plan" value={title} onChange={(e) => setTitle(e.target.value)} required/>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-center p-2 border rounded-lg bg-card">
              <div className="w-full max-w-sm">
                <Calendar mode="single" selected={startDate} onSelect={setStartDate} className="mx-auto rounded-md shadow-sm" required/>
              </div>
            </div>
            {startDate && (<p className="text-xs text-muted-foreground mt-1">
          ...
          <div className="space-y-2">
            ...
            <Input id="days" type="number" min="1" max="7" placeholder="7" value={days} onChange={(e) => setDays(e.target.value)} required/>
            {parseInt(days) > 7 && (<p className="text-xs text-red-500 mt-1">
          ...
          <div className="space-y-2">
            ...
            <Input id="preferences" placeholder="healthy, quick meals, vegetarian" value={preferences} onChange={(e) => setPreferences(e.target.value)} required/>
            <p className="text-xs text-muted-foreground">Separate multiple preferences with commas</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="dietaryRestrictions">Dietary Restrictions</Label>
            <Input id="dietaryRestrictions" placeholder="gluten-free, dairy-free" value={dietaryRestrictions} onChange={(e) => setDietaryRestrictions(e.target.value)}/>
          ...
          <div className="space-y-2">
            ...
            <Input id="calorieTarget" type="number" placeholder="2000" min="500" max="5000" value={calorieTarget} onChange={(e) => setCalorieTarget(e.target.value)} required/>
          </div>
