...
import type { NutritionRecommendation } from "@/ai-services/recipe-ai";
...
export function NutritionInsights() {
  const insightsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<NutritionRecommendation>;
    },
  });
