...
import { Search, Loader2, Utensils, AlertTriangle } from "lucide-react";
...
export default function RecipesPage() {
    ...
    const filteredRecipes = recipes === null || recipes === void 0 ? void 0 : recipes.filter((recipe) => recipe.title.toLowerCase().includes(searchTerm.toLowerCase()));
    if (isLoading) {
    ...
    return (<div className="min-h-screen bg-background">
      <div className="container mx-auto p-6">
        ...
        {!currentGoal && (<div className="mb-6 p-4 rounded-lg border bg-muted/50">
        ...
        <Tabs defaultValue="my-recipes" className="space-y-6">
          ...
          <TabsContent value="my-recipes">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {filteredRecipes === null || filteredRecipes === void 0 ? void 0 : filteredRecipes.map((recipe) => (<RecipeCard key={recipe.id} recipe={recipe} showDelete={recipe.createdBy === (user === null || user === void 0 ? void 0 : user.id)} hideEditDelete={false}/>))}
            </div>
            {(filteredRecipes === null || filteredRecipes === void 0 ? void 0 : filteredRecipes.length) === 0 && (<div className="text-center py-12">
