...
export function UserPreferencesProvider({ children }) {
    const [preferences, setPreferences] = useState(() => {
        ...
        return saved ? Object.assign(Object.assign({}, defaultPreferences), JSON.parse(saved)) : defaultPreferences;
    });
    useEffect(() => {
    ...
    const updatePreference = (key, value) => {
        setPreferences(prev => (Object.assign(Object.assign({}, prev), { [key]: value })));
    };
    ...
    const updateAccentColor = (color) => {
        ...
        setPreferences(prev => (Object.assign(Object.assign({}, prev), { accentColor: color })));
    };
    const resetPreferences = () => {
        setPreferences(defaultPreferences);
    };
    return (<UserPreferencesContext.Provider value={{ preferences, updatePreference, resetPreferences, updateAccentColor }}>
      {children}
